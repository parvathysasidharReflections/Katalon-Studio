...
WebUI.click(findTestObject('Object Repository/Page_Cathy Bell  Madison Conradis/a_New Products'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_New Products  Cathy Bell  Madison Conradis/li_New Products'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Page_New Products  Cathy Bell  Madison Conradis/li_New Products'), 
    'New Products')
